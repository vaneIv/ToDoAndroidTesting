package com.vane.android.todoandroidtesting.data.source.remote
 ...
 */
object TasksRemoteDataSource : TaskDataSource {
    ...
    override suspend fun getTasks(): Success<List<Task>> {
        // Simulating network by delaying the execution.
